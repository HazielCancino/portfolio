...
export function Contact() {
  ...
  const contactInfo = {
    ...
    handle: '@Haziel.Cancino',
    socials: [
      {
        name: 'LinkedIn',
        url: 'www.linkedin.com/in/haziel-cancino-',
      },
      {
        name: 'Youtube',
        url: 'https://www.youtube.com/@hazCancino',
      },
      {
        name: 'Instagram',
        url: 'https://www.instagram.com/haziel_o_o_/',
      },
      {
        name: 'Discord',
        url: 'https://discord.com/users/hazcang',
      },
      {
        name: 'Github',
        url: 'https://github.com/HazielCancino',
      },
      {
        name: 'X',
        url: 'https://x.com/Haziel_o_o_',
      },
    ],
  };
